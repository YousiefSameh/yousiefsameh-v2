...
/**
 * @summary Update a label (name and/or color)
 * @param id      - The project ID
 * @param labelId - The label ID
 * @returns The updated label or an error message
 */
...
/**
 * @summary Delete a label (cascades to TaskLabelAssignment via schema onDelete: Cascade)
 * @param id      - The project ID
 * @param labelId - The label ID
 * @returns 200 on success or an error message
 */
