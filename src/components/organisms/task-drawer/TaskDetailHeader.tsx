...
import { InlineEditText } from "@/components/molecules/task-drawer/InlineEditText";
import { InlineEditSelect } from "@/components/molecules/task-drawer/InlineEditSelect";
    ...
    <div className="flex shrink-0 flex-col gap-2 border-b border-border px-6 py-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <InlineEditSelect
          ...
          renderValue={(v) => <TaskStatusBadge status={v as TaskStatus} size="sm" />}
          className="shrink-0"
        />
